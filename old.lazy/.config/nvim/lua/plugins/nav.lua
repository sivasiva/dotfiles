    ...
    opts = {
        ...
        filesystem = {
            ...
            filtered_items = {
                ...
                never_show = {".git", ".history", ".DS_Store", "thumbs.db", ".idea", ".history",
                -- hide files from these folders, when searching within Neo-Tree explorer
                              "_build", "deps", ".elixir_ls", "dialyzer*", "node_modules*"}
            }
        }
    }
}, -- { "nanotee/zoxide.vim", cmd = "Z" },
{
    ...
    opts = {
        ...
        "~/projects/*", "~/ref/*", "~/dev/*", "~/sandbox/*", "~/projects/notes/*", "~/work/*", "~/lab/*", "~/notion/*",
        "~/work/dm23/*", "~/work/dm2024/*", "~/work/e/*", "~/.config/*", "~/dotter"},
        dashboard_mode = true,
